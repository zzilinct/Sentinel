...
(() => {
  'use strict';
  const { api, esc, $, $$, toast, busy, verdict, wireVerdict } = window.UI;
  ...
  form.addEventListener('submit', async (ev) => {
    ...
    try {
      ...
      out.innerHTML = verdict(data.verdict, { lockedLabel: 'Account' })
        + '<div class="panel actions"><span class="muted">Want virus and malware masks, research, history and live protection?</span><span class="actions__btns"><a class="btn btn--gold btn--sm" href="/signup">Create a free account</a></span></div>';
